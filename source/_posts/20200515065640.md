...
作者：四魂の魊 
来源：CSDN 
原文：https://blog.csdn.net/qq_16885135/article/details/52777871 
版权声明：本文为博主原创文章，转载请附上博文链接！使用 git branch -a 命令可以查看所有本地分支和远程分支（git branch -r 可以只查看远程分支） 
发现很多在远程仓库已经删除的分支在本地依然可以看到。
